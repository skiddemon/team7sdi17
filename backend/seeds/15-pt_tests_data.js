...
exports.seed = async function(knex) {
  ...
  await knex('pt_tests').insert([
    ...
    {run_time: 720, push_ups: 58, sit_ups: 42, score: 80, test_date: '2021-02-10', user_id: 2},
    ...
    {run_time: 720, push_ups: 67, sit_ups: 58, score: 90, test_date: '2022-02-10', user_id: 2},
    ...
    {run_time: 720, push_ups: 67, sit_ups: 58, score: 93, test_date: '2023-02-10', user_id: 2},
