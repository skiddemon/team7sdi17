    ...
    return (
        <div className="mt-10">
            ...
            <Card className="w-fit mx-auto border-[red]">
                <h1 className='text-center'>As a SME, I want to be able to create verified workouts</h1>
            </Card>

            {/* 
            Create Workout button should bring users to a create workout page, probably with a conditionally rendered SME header or something.
            ...
            */}
            ...
            <Card className='w-fit mx-auto  border-[red]'>
                <h1 className='text-center'>As a SME, I want to verify workouts created by general users.</h1>
            </Card>
            ...
            <Card className='w-fit mx-auto  border-[red]'>
                <h1 className='text-center'>As a SME, I want to see workout metrics of military members assigned to my installation/unit.</h1>
            </Card>

            <Card className='w-fit mx-auto  border-[red]'>
                <h1 className='text-center'>As a SME, I want to list my areas of expertice in sports medicine in order to review and give a seal of approval that this routine is beneficial and others should check it out.</h1>
            </Card>
            </Card>
        </div>
